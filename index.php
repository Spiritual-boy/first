...
<head>
    ...
    <style>
        img {width: 10px; position: absolute;left: 163px; top: 5px;}
    </style>
</head>
<body>
<div class="menu-wrap">
...
<!-- Header Section End -->
    ...
    <div class="container">
        <input type="text" id="sousuokuang"/>
        <img  type="submit"src="img/maike.jpg" onclick="f1()">
        <button type="button"  name="sub" >跳转</button>
    </div>

<?php
$a=$_GET['id'];
if($a){
    echo "<script>document.getElementById('sousuokuang').value=$a</script>";
}
?>
...
<section id="services" class="section">
    <div class="container">
        <div class="section-header">
            <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">我们的 <span>服务</span></h2>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="item-boxes wow fadeInDown" data-wow-delay="0.2s">
                    ...
                    <a href="/untitled1/map.html">地图导航</a>
                    <p>帮助老人快速导航，回家</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="item-boxes wow fadeInDown" data-wow-delay="0.4s">
                    ...
                    <a href="/untitled1/photo.html">亲情相册</a>
                    <p>老人与亲人的快乐时光</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="item-boxes wow fadeInDown" data-wow-delay="0.6s">
                    ...
                    <a href="/untitled1/fullcalendar.html">日历</a>
                    <p>日历与备忘录</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="site-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s">
                    <p>UIdeck All copyrights reserved &copy; 2017 - More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
                </div>
            </div>
        </div>
    </div>
